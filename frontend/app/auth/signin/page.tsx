...
export default function SignInPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#09090b] text-[#fafafa]">
      ...
      {/* Sign In Content */}
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:8 relative overflow-hidden">
        ...
        <div className="max-w-md w-full relative z-10">
          <div className="card p-8">
            ...
            <div className="space-y-4">
              <Link
                href="/auth/google"
                className="card card-hover p-4 flex items-center justify-center space-x-3 group"
              >
                ...
                <span className="text-white font-medium group-hover:text-zinc-300 transition-colors">
