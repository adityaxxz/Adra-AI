  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ width: 600, height: 600, top: -150, left: '50%', transform: 'translateX(-50%)' }}
      />

      {/* Nav */}
      <nav
        className="relative z-10 flex items-center px-8 py-5 border-b"
        style={{ borderColor: 'var(--border)', background: 'rgba(10,10,15,0.7)', backdropFilter: 'blur(16px)' }}
      >
        ...
        <div className="w-full max-w-sm animate-scale-in">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
              Sign in to continue to Adra-AI
            </p>
          </div>
          ...
          >
            <Link
              ...
              className="flex items-center gap-4 w-full px-4 py-3.5 rounded-xl text-sm font-medium transition-all"
              style={{
